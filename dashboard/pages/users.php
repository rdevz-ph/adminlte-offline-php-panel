...
<div class="container-fluid py-4">
            ...
            <div class="card shadow-sm border">
                <div
                    ...
                    <div>
                        ...
                        <small>View, add, edit, and manage users of the system</small>
                    </div>
                    <div class="d-flex align-items-center gap-2">
                        <button class="btn btn-success mr-3" data-toggle="modal" data-target="#addUserModal">
    ...
    <div class="card shadow">
        <div class="card-header bg-light">
            ...
            <small class="text-muted">Manage users in the system</small>
        </div>
        <div class="card-body">
                        ...
                        <tr>
                            ...
                            <td>
                                <button class="btn btn-sm btn-info edit-btn" data-id="<?= $user['id'] ?>"
                                    ...
                                    data-user_type="<?= $user['user_type'] ?>" data-toggle="modal"
            ...
            <form method="POST" action="functions/user.php?action=add">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <input type="text" name="name" id="add-name" class="form-control mb-2" placeholder="Name"
                            required>
